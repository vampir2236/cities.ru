...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return Yii::$app->db->cache(function ($db) use ($email) {
    ...
    /**
     * Поиск аккаунта по токены подтверждения
     * @param $token
     * @return null|static
     */
    ...
    /**
     * Сгенерировать токен подтверждения аккаунта
     */
    ...
    /**
     * Удалить токен подтверждения аккаунта
     */
    ...
    /**
     * Получить ссылку для email
     * @return null|string
     */
    public function getEmailLink()
    {
        return $this->phone ? 'mailto:' . $this->email : null;
    }


    /**
     * Получить ссылку для телефона
     * @return null|string
     */
